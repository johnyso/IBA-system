...
public class RoomDetailActivity extends FragmentActivity {
    ...
    private NavDrawerListAdapter adapterNavigation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.adapterNavigation = new NavDrawerListAdapter(getApplicationContext(),
                navDrawerItems);
        mDrawerList.setAdapter(this.adapterNavigation);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.set_up_speaker, menu);
        return true;
    }
